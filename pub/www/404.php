                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center">
                            ...
                            <h2 class="wow fadeInUp animated" data-wow-delay=".6s">Opps! We have some problems</h2>
                            ...
                            <a href="index.php" class="btn btn-dafault btn-home wow fadeInUp animated" data-wow-delay="1.1s">Go Home</a>
