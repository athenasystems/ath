...
<link href="/pub/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  ...
  <link href="/pub/bootstrap/css/customer_theme.css" rel="stylesheet">
...
$addons = array();
$addons[] = (object) array("name" => "Quotes","url" => '/quotes');
$addons[] = (object) array("name" => "Invoices","url" => '/invoices');
...
$i=1;
	...
	<li><a href="<?php echo $r->url?>" title="<?php echo htmlentities($r->name)?>">
 					<?php echo htmlentities($r->name)?></a></li>	<?php
		$i++;
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="/account?id=<?php echo $custID; ?>">Your Details</a></li>

                <li><a href="/pass.php?pg=logout&s=<?php echo $sitesid; ?>">Log	Out</a></li>
              </ul>
            </li>
          </ul>
        </div><!--/.nav-collapse -->
...
<div >
<?php echo $owner->co_name?> welcomes <?php echo $custDets->co_name?>
</div>