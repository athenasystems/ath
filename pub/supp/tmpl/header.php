...
$addons[] = (object) array("name" => "Quotes","url" => '/quotes');
	...
	<li><a href="<?php echo $r->url?>" title="<?php echo htmlentities($r->name)?>">
 					<?php echo htmlentities($r->name)?></a></li>
				</li>
				<?php
				}
				?>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="/account?id=<?php echo $staffid; ?>">Your Details</a></li>
...
<?php echo $owner->co_name?> Supplier Control Panel -
    Welcomes <?php echo $suppDets->co_name?>