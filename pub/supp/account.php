...
$sqltext = "SELECT usr,pw FROM pwd where suppid=" . $suppID;
#print "<br/>$sqltext";
$res = $dbsite->query($sqltext); # or die("Cant get the supp!");
$rrt = $res[0];
...
<?php
if ((isset($done))&&($done)) {
	wereGood('Password has been changed');
}
	...
	<fieldset class="form-group">
		...
		<ol>
			<li><label>Log in Username</label> <span
				style="line-height: 1.8em; font-weight: bold;"><?php echo $rrt->usr?>
			</span>
			</li>
			<?php
