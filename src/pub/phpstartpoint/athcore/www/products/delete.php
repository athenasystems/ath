...
if ((isset($_GET['go'])) && ($_GET['go'] == "y")) {
	...
	$productsDelete = new Products();
	$productsDelete->setProductsid($_GET['id']);
	$productsDelete->deleteFromDB();
	
	header("Location: /products/?ItemDeleted=y");
...
<div class="panel panel-info">
	<div class="panel-heading">
		<strong>Viewing <?php echo $products->getProductsid();?></strong>
	</div>
